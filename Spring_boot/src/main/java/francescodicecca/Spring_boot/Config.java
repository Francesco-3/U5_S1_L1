package francescodicecca.Spring_boot;

import francescodicecca.Spring_boot.entities.*;
...
public class Config {
    ...
    // Menu
    @Bean
    public Menu menu(Pizza margheritaPizza, Pizza hawaiianPizza, Pizza salamiPizza,
